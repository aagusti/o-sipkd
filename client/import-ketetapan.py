...
def data_found(source):
    sql = text("""SELECT COUNT(*) C FROM apbd.ar_invoice_transaksi
...
def insert(source):
    sql = text("""INSERT INTO apbd.ar_invoice_transaksi(kode, disabled, created, 
...
def update(source):
    sql = text("""UPDATE apbd.ar_invoice_transaksi 
                    set kode           = :kode,
                        disabled       = :disabled,
                        created        = :created,
                        updated        = :updated,
